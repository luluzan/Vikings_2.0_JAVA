...
import java.util.List;//incluimos list para los arrya
...
class WarTest {
    ...
    War war = new War(health, strength, name);
    ...
    public void should_assign_an_empty_array_to_the_saxonArmy_property() {
        List<Saxon> saxonArmy = war.getSaxonArmy();//CAMBIAMOS OBJECT POR SAXON PARA QUE COINCIDA CON EL TIPO DE EL LIST
